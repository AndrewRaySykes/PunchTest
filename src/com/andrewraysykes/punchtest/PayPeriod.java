...
public class PayPeriod {
	...
	public String toString() {
		return "PayPeriod [id=" + id + 
				", startDateTime=" + startDateTime.format(PunchConstants.DATETIME_FORMAT_FOR_SQL).toString()  + 
				", endDateTime=" + endDateTime.format(PunchConstants.DATETIME_FORMAT_FOR_SQL).toString() + 
				"]";
	}
